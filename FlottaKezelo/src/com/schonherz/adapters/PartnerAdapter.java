	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null) {
			...
			//	ImageView ivAvatar = 
				...
				// set name
				TextView tvName = (TextView)convertView.findViewById(com.schonherz.flottadroid.R.id.tvNamePartner);
				tvName.setText(currentPartner.getPartnerNev());
				// set phone
				TextView tvPhone = (TextView)convertView.findViewById(com.schonherz.flottadroid.R.id.tvPhonePartner);
				tvPhone.setText(currentPartner.getPartnerTelefonszam());
				// set email
				TextView tvEmail = (TextView)convertView.findViewById(com.schonherz.flottadroid.R.id.tvEmailPartner);
